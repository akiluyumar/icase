...
$susp_query = "SELECT * FROM tbl_suspects WHERE crno='$field'";
    ...
    //Fetch to teams to assign cases to
            ...
            <div id="page-inner">
                ...
                <div class="row">
                            ...
                            <div class="panel-heading">
                                <h3>
                                    ...
                                    <span class="pull-right">
                                        <a class="btn btn-primary" href="edit_casediary.php?a=edit&t=casediary&id=<?php echo $casediary['crno']; ?>">Edit</a>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="media media-default">
                                  ...
                                  <div class="media-body">
                                      <h4 class="media-heading"><a href="suspect_details.php?a=viewdetails&t=suspect&id=<?php echo $suspects['susp_id']; ?>&crno=<?php echo $casediary['crno']; ?>"><?php echo $suspects['susp_name']; ?></a></h4>
                    ...
                    <div class="col-sm-4">
                        <div class="panel panel-success">
                            ...
                            <div class="panel-body">
                                ...
                                <input type="hidden" id="caseid" value="<?php echo $casediary['crno']; ?>">
                                <div id="assignToTeamRes"></div>
                    ...
                    <div class="col-sm-4">
                        <div class="panel panel-success">
                            <div class="panel-heading">
                                <h3 class="panel-title">Ministry of Justice</h3>
                            </div>
                    ...
                    <div class="col-sm-4">
                        <div class="panel panel-success">
                            <div class="panel-heading">
                                <h3 class="panel-title">Prisons</h3>
                            </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          <form class="form-horizontal" role="form">
              ...
              <input type="hidden" id="fromModl">
              <div class="form-group">
                  <label class="control-label col-sm-4">From</label>
                  <div class="col-sm-8">
                      <input type="text" class="form-control" id="fromCaseOrgName">
                  </div>
              </div>
              <!-- Forwarding To -->
